/*
	TDOperation.h
	The implementation of properties and methods for the TDOperation object.
...
@implementation TDOperation
	...
	+ (TDOperation*) createWithNode: (CXMLNode*) node
	{
        ...
        for (CXMLNode* child in [node children] ){
            if ([child.name isEqualToString:@"m:Operations"]) {
                
                NSLog(@"            Попытка добавления операции child=%@", child);
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[TDOperation class]]) {
